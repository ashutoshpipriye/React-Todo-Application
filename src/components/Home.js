...
const Home = () => {
    ...
    const sortPriority = () => {
        ...
        priorityData = [...none, ...low, ...medium, ...high];
    ...
    return (
        <div>
            ...
            <Tabs
                searchData={searchTask.length < 1 ? data : searchResults} // searchData send to tabs length is greater than one
                loadTask={loadTask}
                sortFunc={sortFunc}
